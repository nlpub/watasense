...
def evaluate(path):
    ...
    v_measure, scores, clusters_gold, clusters_system = 0., OrderedDict(), [], []
    ...
    for lemma in lemmas:
        ...
        v_measure += v_measure_score(clusters_gold, clusters_system) * len(instances) / total
